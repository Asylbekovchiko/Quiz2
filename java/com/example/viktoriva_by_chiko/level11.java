...
public class level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fon= MediaPlayer.create(this, R.raw.movies);
        correct=MediaPlayer.create(this, R.raw.correct);
        incorrect=MediaPlayer.create(this, R.raw.incorrect);

        TextView tvlvl=findViewById(R.id.lvl);
        tvlvl.setText(R.string.level11);


        ImageView img2 = findViewById(R.id.back1);
        img2.setImageResource(R.drawable.bbb);
        ...
        dialog.setContentView(R.layout.elevenlvldialog);
...
/////////////////////////////////////////////////////////////
        ...
        final Animation a = AnimationUtils.loadAnimation(level11.this, R.anim.alpha);//в
        numLeft=random.nextInt(10);
        imgLeft.setImageResource(array.img11[numLeft]);
        t1.setText(array.texts11[numLeft]);
        ...
        imgRight.setImageResource(array.img11[numRight]);
        t2.setText(array.texts11[numRight]);
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            if(event.getAction()==MotionEvent.ACTION_DOWN){
                ...
                if(count==15){
                    ...
                    imgLeft.setImageResource(array.img11[numLeft]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
                    t1.setText(array.texts11[numLeft]);
                    ...
                    imgRight.setImageResource(array.img11[numRight]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
