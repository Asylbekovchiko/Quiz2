...
public class level15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fon= MediaPlayer.create(this, R.raw.deth);
        correct=MediaPlayer.create(this, R.raw.correct);
        incorrect=MediaPlayer.create(this, R.raw.incorrect);


        TextView tvlvl=findViewById(R.id.lvl);
        tvlvl.setText(R.string.level15);


        ImageView img2 = findViewById(R.id.back1);
        img2.setImageResource(R.drawable.fffon);
        ...
        dialog.setContentView(R.layout.fiveteenlvldialog);
...
/////////////////////////////////////////////////////////////
        ...
        final Animation a = AnimationUtils.loadAnimation(level15.this, R.anim.alpha);//в
        numLeft=random.nextInt(20);
        imgLeft.setImageResource(array.img15[numLeft]);
        t1.setText(array.texts15[numLeft]);


        numRight=random.nextInt(20);
        while(array.value15[numLeft]==array.value15[numRight]){
            numRight=random.nextInt(20);

        }
        imgRight.setImageResource(array.img15[numRight]);
        t2.setText(array.texts15[numRight]);
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            if(event.getAction()==MotionEvent.ACTION_DOWN){
                ...
                if(count==15){
                    ...
                    imgLeft.setImageResource(array.img15[numLeft]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
                    t1.setText(array.texts15[numLeft]);
                    ...
                    imgRight.setImageResource(array.img15[numRight]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
        ...
        imgRight.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if(event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if(array.value15[numLeft]<array.value15[numRight]){
