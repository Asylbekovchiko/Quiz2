...
public class level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fon= MediaPlayer.create(this, R.raw.actors);
        ...
        dialog.setContentView(R.layout.thirdlvldialog);
...
/////////////////////////////////////////////////////////////
        ...
        final Animation a = AnimationUtils.loadAnimation(level3.this, R.anim.alpha);//в
        numLeft=random.nextInt(17);
        imgLeft.setImageResource(array.img3[numLeft]);
        t1.setText(array.texts3[numLeft]);


        numRight=random.nextInt(17);
        while(numLeft==numRight){
            numRight=random.nextInt(17);

        }
        imgRight.setImageResource(array.img3[numRight]);
        t2.setText(array.texts3[numRight]);
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            if(event.getAction()==MotionEvent.ACTION_DOWN){
                ...
                if(count==15){
                    ...
                    numLeft=random.nextInt(17);     //рандомное число для imgleft and textleft
                    imgLeft.setImageResource(array.img3[numLeft]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
                    t1.setText(array.texts3[numLeft]);

                    imgLeft.startAnimation(a);
                    numRight=random.nextInt(17);//рандомное число для right
                    while(numLeft==numRight){
                        numRight=random.nextInt(17);
                    }
                    imgRight.setImageResource(array.img3[numRight]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
