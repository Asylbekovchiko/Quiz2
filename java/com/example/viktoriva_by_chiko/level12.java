...
public class level12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fon= MediaPlayer.create(this, R.raw.run);
        correct=MediaPlayer.create(this, R.raw.correct);
        incorrect=MediaPlayer.create(this, R.raw.incorrect);


        TextView tvlvl=findViewById(R.id.lvl);
        tvlvl.setText(R.string.level12);


        ImageView img2 = findViewById(R.id.back1);
        img2.setImageResource(R.drawable.twmain);
        ...
        dialog.setContentView(R.layout.twelvelvldialog);
...
/////////////////////////////////////////////////////////////
        ...
        final Animation a = AnimationUtils.loadAnimation(level12.this, R.anim.alpha);//в
        numLeft=random.nextInt(10);
        imgLeft.setImageResource(array.img12[numLeft]);
        t1.setText(array.texts12[numLeft]);
        ...
        imgRight.setImageResource(array.img12[numRight]);
        t2.setText(array.texts12[numRight]);
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            if(event.getAction()==MotionEvent.ACTION_DOWN){
                ...
                if(count==15){
                    ...
                    imgLeft.setImageResource(array.img12[numLeft]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
                    t1.setText(array.texts12[numLeft]);
                    ...
                    imgRight.setImageResource(array.img12[numRight]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
