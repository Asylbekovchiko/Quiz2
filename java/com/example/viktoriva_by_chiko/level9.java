...
public class level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fon= MediaPlayer.create(this, R.raw.smit);
        ...
        tvlvl.setText(R.string.leve91);

        ImageView img2 = findViewById(R.id.back1);
        img2.setImageResource(R.drawable.nbackdialog);
        ...
        dialog.setContentView(R.layout.ninelvldialog);
...
/////////////////////////////////////////////////////////////
        ...
        final Animation a = AnimationUtils.loadAnimation(level9.this, R.anim.alpha);//в
        numLeft=random.nextInt(10);
        imgLeft.setImageResource(array.img9[numLeft]);
        t1.setText(array.texts9[numLeft]);
        ...
        imgRight.setImageResource(array.img9[numRight]);
        t2.setText(array.texts9[numRight]);
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            if(event.getAction()==MotionEvent.ACTION_DOWN){
                ...
                if(count==15){
                    ...
                    imgLeft.setImageResource(array.img9[numLeft]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
                    t1.setText(array.texts9[numLeft]);
                    ...
                    imgRight.setImageResource(array.img9[numRight]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
