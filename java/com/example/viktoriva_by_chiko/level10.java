...
public class level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvlvl.setText(R.string.level10);


        ImageView img2 = findViewById(R.id.back1);
        img2.setImageResource(R.drawable.tbb);
        ...
        dialog.setContentView(R.layout.tenlvldialog);
...
/////////////////////////////////////////////////////////////
        ...
        final Animation a = AnimationUtils.loadAnimation(level10.this, R.anim.alpha);//в
        numLeft=random.nextInt(10);
        imgLeft.setImageResource(array.img10[numLeft]);
        t1.setText(array.texts10[numLeft]);
        ...
        imgRight.setImageResource(array.img10[numRight]);
        t2.setText(array.texts10[numRight]);
        ...
        imgLeft.setOnTouchListener(new View.OnTouchListener() {
            ...
            if(event.getAction()==MotionEvent.ACTION_DOWN){
                ...
                if(count==15){
                    ...
                    imgLeft.setImageResource(array.img10[numLeft]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
                    t1.setText(array.texts10[numLeft]);
                    ...
                    imgRight.setImageResource(array.img10[numRight]);//достаем из массива картинку(например рандомное число 1, следовательно достается картинка под номером один(отсчет идет с 0 до 9))
